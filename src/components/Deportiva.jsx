...
const imgCatalogo = require('../assets/ropaDama/2.png')
...
const Deportiva = () => {
  return (
    <>
      ...
      <div className=" mt-5 ">
        <h3 className='container'>Entrenar y ser glamorosa esta de moda</h3>
     </div>
      ...
      <div className="card mt-5 me-5" style={{width: '18rem'}}>
              <img src={imgCatalogo} className="card-img-top" alt="..." />
