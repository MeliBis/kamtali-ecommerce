...
const Footer = () => {
  return (
    <div>
      <footer className="text-white py-4 bg-dark mt-4">
...
{/* iconos */}
              <li className="mt-3 container-fluid d-flex  justify-content-between">
                <a href="https://www.facebook.com/kamtali.store" target={"blank"} className="text-reset ">
                    <svg
                ...
                <a href=" https://twitter.com/Kamtali_mx" target={"blank"} className="text-reset">
               <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    fill="currentColor"
                ...
                <a href="https://www.instagram.com/kamtali.store/" target={"blank"}  className="text-reset me-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    fill="currentColor"
                ...
                <a href="https://api.whatsapp.com/send?phone=525615999821&text=hola!%20¿cómo%20te%20puedo%20ayudar??" target={"blank"}  className="text-reset">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    fill="currentColor"
