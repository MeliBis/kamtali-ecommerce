          ...
          <nav className="row">
            ...
            <ul className="col-12 col-md-4 list-unstyled">
              ...
              <li className="mt-3 container-fluid  ">
                <Link to="https://www.facebook.com/kamtali.store" className="text-reset me-4">
{/*                 https://www.facebook.com/kamtali.store
 */}                  <svg
                ...
                <Link to="https://twitter.com/Kamtali_mx" className="text-reset me-4">
{/*                 https://twitter.com/Kamtali_mx
 */}                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    fill="currentColor"
...
{/*                 https://www.instagram.com/kamtali.store/
 */}                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    fill="currentColor"
